...
(*Slider widget*)
val slider_color: Gctx.color -> int * int -> int -> 
                  widget * int value_controller

(*Thickness slider*)
val slider_thick: int -> int -> int -> widget * int value_controller

(*Slider counter*)
val slider_count: int -> string -> widget * int value_controller
